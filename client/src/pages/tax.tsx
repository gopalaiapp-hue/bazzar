...
import { TAX_DATA } from "@/lib/mock-data";
      ...
      <div className="p-6 space-y-6">
        <div className="flex justify-between items-end">
          <div>
            ...
            <p className="text-muted-foreground text-sm">AY 2025-26 • Due in 45 Days</p>
          </div>
        ...
        <div className="bg-gradient-to-br from-primary to-blue-700 rounded-2xl p-6 text-white shadow-lg relative overflow-hidden">
          ...
          <div className="flex justify-between items-start mb-6">
            <div>
              ...
              <h2 className="text-3xl font-bold">₹{TAX_DATA.taxPayable.toLocaleString()}</h2>
            </div>
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-bold text-green-400">₹82,500</span>
              </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-bold text-gray-300">₹1,12,000</span>
              </div>
              <Progress value={65} className="h-2 bg-gray-700" />
            </div>
            <p className="text-xs text-gray-400 pt-2">
              You save <span className="text-green-400 font-bold">₹29,500</span> with the New Regime.
            </p>
          </div>
        </section>
      </div>
